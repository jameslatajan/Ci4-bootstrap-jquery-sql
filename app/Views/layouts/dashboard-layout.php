...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light">JeffLTE</span>
            </a>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                <li class="nav-item">
                                    <a href="#" class="nav-link">
                                        <i class="far fa-code nav-icon "></i>
                                        <p>Insertion Sort</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="#" class="nav-link">
                                        ...
                                        <i class="far fa-grid nav-icon"></i>
                                        <p>Bubble Sort</p>
                                    </a>
                                </li>
                                <li class="nav-item">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2023 <a href="<?= base_url() ?>">Jefferson System</a>.</strong>
            All rights reserved.
    ...
    <!-- Datatables script -->
    <script src="<?= base_url()?>/js/table1.js"></script>
