                                ...
                                <div class="card-body mx-md-4">
                                    ...
                                    <form id="formid">
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <input type="text" name="name" id="name" class="form-control" placeholder="Full Name or Nick Name" />
                                        </div>
                                        <div class="form-outline mb-4">
                                        ...
                                        <div class="text-center pt-1 mb-5 pb-1 d-grid gap-2">
                                            <button class="btn btn-danger" type="submit" id="register">Register</button>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-center pb-4">
                                            <p class="mb-0 me-2">Don't have an account?</p>
                                            <a type="button" class="btn btn-outline-danger" href="<?php echo base_url() ?>"> Login here</a>
                                        </div>
                                    </form>
